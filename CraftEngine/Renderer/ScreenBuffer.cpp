...
Craft::ScreenBuffer::ScreenBuffer(const Vector2& screenSize)
	: size(screenSize)
{
	// 콘솔 버퍼 생성
...
Craft::ScreenBuffer::~ScreenBuffer()
{
	// 콘솔 닫기
	if (buffer)
	{
...
void Craft::ScreenBuffer::Clear() const
{
	// 콘솔 전체를 지우는 함수
...
void Craft::ScreenBuffer::Draw(const CHAR_INFO* const charInfo) const
{
